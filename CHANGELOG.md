...
## cpa-vscode-oai-0.0.3 - 2026-04-27

### 新增

- 新增用户提供的知乎参考长图：`images/reference/zhihu-reference-long-image.jpg`。
- README 新增“知乎参考长图（用户提供）”说明，保留原图用于对照。

### 说明

- 因长图分辨率较低，部分代码/配置文字无法稳定识别，本次不强行转写，避免误导小白用户。
